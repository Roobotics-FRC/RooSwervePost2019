...
public final class RobotMap {
    ...
    public static MotorConfig getRotatorMotorConfig(Drivetrain.WheelID wheelID) {
        switch (wheelID) {
            case LEFT_1:
                return new MotorConfig(16, false, NeutralMode.Brake, true,
                        new PID(0, 3.5, 0, 3));
            case LEFT_2:
                return new MotorConfig(12, false, NeutralMode.Brake, true,
                        new PID(0, 3.5, 0, 3));
            case RIGHT_1:
                return new MotorConfig(18, false, NeutralMode.Brake, true,
                        new PID(0, 3.5, 0, 3));
            case RIGHT_2:
                return new MotorConfig(14, false, NeutralMode.Brake, true,
                        new PID(0, 3.5, 0, 3));
            default:
